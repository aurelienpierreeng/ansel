/*
    ...
    Copyright (C) 2018-2023 Aurélien PIERRE.
...
typedef enum dt_iop_filmicrgb_colorscience_type_t
{
  ...
  DT_FILMIC_COLORSCIENCE_V10 = 9, // AgX, extra bleach
                 ...
                 constant const float *const export_matrix_in, constant const float *const export_matrix_out, const float y_min, const float y_max)
{
  ...
  switch(color_science)
  {
    ...
    default:
    {
      // v5 to v10 (all AgX variants) are handled as chroma variants, not here
                 ...
                 const float4 luma_coeffs, const float agx_beta_hue)
{
  ...
  switch(color_science)
  {
    ...
    case DT_FILMIC_COLORSCIENCE_V10:
    {
