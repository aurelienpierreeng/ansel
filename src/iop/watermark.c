/*
    ...
    Copyright (C) 2010, 2012 José Carlos García Sogo.
    ...
    Copyright (C) 2018-2019, 2021 Heiko Bauke.
    ...
    Copyright (C) 2021 Benjamin Grimm-Lebsanft.
...
#pragma omp parallel for dt_omp_default() \
  firstprivate(roi_out, in, out, sd, opacity, ch)   \
  schedule(static)
#endif
...
{
  piece->data = dt_calloc_align(sizeof(dt_iop_watermark_data_t));
  piece->data_size = sizeof(dt_iop_watermark_data_t);
}
