/*
    ...
    Copyright (C) 2012 Terry Jeffress.
    Copyright (C) 2012, 2014, 2016, 2019 Ulrich Pegelow.
...
{
  dt_iop_lowlight_data_t *d = (dt_iop_lowlight_data_t *)dt_calloc_align(sizeof(dt_iop_lowlight_data_t));
