...
#pragma omp parallel for dt_omp_default() \
  firstprivate(roi_out, saturation, a_scale, a_base, b_scale, b_base, in, out) \
  schedule(static)
#endif
...
{
  piece->data = dt_calloc_align(sizeof(dt_iop_colorcorrection_data_t));
  piece->data_size = sizeof(dt_iop_colorcorrection_data_t);
}
