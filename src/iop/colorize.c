/*
    ...
    Copyright (C) 2012-2014, 2016-2017, 2019 Tobias Ellinghaus.
...
__OMP_PARALLEL_FOR__(private(in, out) )
...
{
  piece->data = dt_calloc_align(sizeof(dt_iop_colorize_data_t));
  piece->data_size = sizeof(dt_iop_colorize_data_t);
}
