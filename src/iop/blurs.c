...
{
#ifdef _OPENMP
#pragma omp parallel for dt_omp_default() dt_omp_firstprivate(width, height, in, out) \
...
#ifdef _OPENMP
#pragma omp parallel for simd dt_omp_default() dt_omp_firstprivate(width, height, buffer) \
...
#ifdef _OPENMP
#pragma omp parallel for simd dt_omp_default() dt_omp_firstprivate(width, height, buffer, n, m, k, rotation, eps, radius) \
...
#ifdef _OPENMP
#pragma omp parallel for simd dt_omp_default() dt_omp_firstprivate(width, height, buffer, A, B, C, radius, offset, M, eps) \
    schedule(simd: static) aligned(buffer:64)
#endif
...
#ifdef _OPENMP
#pragma omp parallel for simd dt_omp_default() dt_omp_firstprivate(width, height, buffer, radius) \
    schedule(simd: static) aligned(buffer:64) collapse(2)
#endif
  for(size_t i = 0; i < height; i++)
    for(size_t j = 0; j < width; j++)
...
#ifdef _OPENMP
#pragma omp parallel for simd dt_omp_default() dt_omp_firstprivate(width, height, buffer, kernel_2) \
...
{
#ifdef _OPENMP
#pragma omp parallel for simd dt_omp_default() dt_omp_firstprivate(width, height, buffer, norm) \
    schedule(simd: static) aligned(buffer:64)
#endif
  for(size_t i = 0; i < width * height; i++)
  {
...
#ifdef _OPENMP
#pragma omp parallel for simd dt_omp_default() dt_omp_firstprivate(padded_width, padded_height, roi_in, in, padded_in) \
