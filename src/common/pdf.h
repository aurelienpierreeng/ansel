 ...
 *    Copyright (C) 2015, 2020-2021 Pascal Obry.
 *    Copyright (C) 2015-2016, 2018 Tobias Ellinghaus.
...
typedef enum dt_pdf_stream_encoder_t
{
  ...
  DT_PDF_STREAM_ENCODER_DCT       = 2   // the caller hands over JPEG bytes, written as they are
