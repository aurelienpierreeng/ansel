/*
    ...
    Copyright (C) 2014-2016, 2020 Pascal Obry.
...
#ifdef _OPENMP
#pragma omp parallel for schedule(static) default(firstprivate) firstprivate(ptr_in, ptr_out, hTransform, height, width)
#endif
