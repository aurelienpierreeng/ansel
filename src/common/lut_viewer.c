...
dt_lut_viewer_t *dt_lut_viewer_new(dt_gui_module_t *module)
{
  ...
  viewer->cached_rotation_around_axis = dt_nan();
  viewer->cached_rotation_of_axis = dt_nan();
  viewer->cached_slice_depth = dt_nan();
  viewer->cached_slice_thickness = dt_nan();
  viewer->cached_zoom = dt_nan();
  viewer->cached_pan_x = dt_nan();
  viewer->cached_pan_y = dt_nan();
  viewer->cached_shift_threshold = dt_nan();
  viewer->cached_ppd = dt_nan();
  viewer->sample_cache_rotation_around_axis = dt_nan();
  viewer->sample_cache_rotation_of_axis = dt_nan();
  viewer->sample_cache_slice_depth = dt_nan();
  viewer->sample_cache_slice_thickness = dt_nan();
  viewer->sample_cache_shift_threshold = dt_nan();
