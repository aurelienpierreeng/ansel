...
static dt_signal_description _signal_description[DT_SIGNAL_COUNT] = {
  ...
  { "dt-canvas-changed", NULL, NULL, G_TYPE_NONE, g_cclosure_marshal_VOID__VOID, 0, NULL, NULL,
    FALSE }, // DT_SIGNAL_CANVAS_CHANGED
  ...
  { "dt-control-notebook-tab-changed", NULL, NULL, G_TYPE_NONE, g_cclosure_marshal_generic, 1, pointer_arg, NULL,
    FALSE }, // DT_SIGNAL_CONTROL_NOTEBOOK_TAB_CHANGED (owner)
