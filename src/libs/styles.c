/*
    ...
    Copyright (C) 2010-2011 Olivier Tribout.
    Copyright (C) 2010-2012, 2014-2017 Tobias Ellinghaus.
    ...
    Copyright (C) 2013-2014, 2019-2022 Pascal Obry.
...
static void import_clicked(GtkWidget *w, gpointer user_data)
{
  ...
  gtk_file_filter_add_pattern(filter, "*.DTSTYLE");
  gtk_file_filter_set_name(filter, _("Ansel style files"));
...
void gui_init(dt_lib_module_t *self)
{
  ...
  GtkWidget *style_tree_sw = dt_ui_scroll_wrap(GTK_WIDGET(d->tree), 250, "plugins/lighttable/style/windowheight",
                                               DT_UI_RESIZE_DYNAMIC);
  gtk_box_pack_start(GTK_BOX(self->widget), style_tree_sw, FALSE, FALSE, 0);
  ...
  GtkWidget *hbox3 = gtk_box_new(GTK_ORIENTATION_HORIZONTAL, DT_GUI_BOX_SPACING);
