...
int dt_lua_init_image(lua_State *L)
{
  ...
  luaA_struct_member_name(L, dt_image_t, geoloc.longitude, protected_double, longitude); // set to dt_nan() if value is not set
  luaA_struct_member_name(L, dt_image_t, geoloc.latitude, protected_double, latitude); // set to dt_nan() if value is not set
  luaA_struct_member_name(L, dt_image_t, geoloc.elevation, protected_double, elevation); // set to dt_nan() if value is not set
