                                       ...
                                       dt_iop_roi_t *oroi, int delta)
{
  ...
  int iter = simplex(_nm_fitness, start, 4, epsilon, 1.0, maxiter, NULL, rest);

  dt_vprint(DT_DEBUG_TILING, "[_nm_fit_output_to_input_roi] simplex: %d, delta: %d, epsilon: %f\n", iter, delta, epsilon);
