/*
    ...
    Copyright (C) 2011-2013, 2016-2017, 2019 Ulrich Pegelow.
    Copyright (C) 2012 Richard Wonka.
    Copyright (C) 2013 Aldric Renaudin.
    Copyright (C) 2013-2014, 2016, 2018-2019 Tobias Ellinghaus.
...
void dt_develop_blendif_rgb_hsl_make_mask(const struct dt_dev_pixelpipe_t *pipe,
                                          const struct dt_dev_pixelpipe_iop_t *piece,
                                          const float *const a, const float *const b, float *const mask);
...
void dt_develop_blendif_raw_blend(const struct dt_dev_pixelpipe_t *pipe,
                                  const struct dt_dev_pixelpipe_iop_t *piece, const float *const a,
                                  float *const b, const float *const mask,
...
int dt_develop_blend_process_cl(struct dt_iop_module_t *self, struct dt_dev_pixelpipe_t *pipe,
