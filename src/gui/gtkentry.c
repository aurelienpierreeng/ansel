/*
    ...
    Copyright (C) 2024-2026 Aurélien PIERRE.
...
const dt_gtkentry_completion_spec *dt_gtkentry_get_default_path_compl_list()
{
  static dt_gtkentry_completion_spec default_path_compl_list[]
      = { { "FOLDER.NAME", N_("$(FOLDER.NAME) - name of the folder containing the input image") },
          ...
          { "FILE.MONTH", N_("$(FILE.MONTH) - month of modification of the input image") },
          { "FILE.DAY", N_("$(FILE.DAY) - day of modification of the input image") },
          { "FILE.HOUR", N_("$(FILE.HOUR) - hour of modification of the input image") },
          { "FILE.MINUTE", N_("$(FILE.MINUTE) - minute of modification of the input image") },
          { "FILE.SECOND", N_("$(FILE.SECOND) - second of modification of the input image") },
          ...
          { "IMPORT.DATE", N_("$(IMPORT.DATE) - import date (YYYY-MM-DD HH:MM:SS)") },
          { "CHANGE.DATE", N_("$(CHANGE.DATE) - last change date (YYYY-MM-DD HH:MM:SS)") },
          { "EXPORT.DATE", N_("$(EXPORT.DATE) - last export date (YYYY-MM-DD HH:MM:SS)") },
          { "PRINT.DATE", N_("$(PRINT.DATE) - last print date (YYYY-MM-DD HH:MM:SS)") },
          ...
          { "ANSEL.NAME", N_("$(ANSEL.NAME) - Ansel name") },
          { "ANSEL.VERSION", N_("$(ANSEL.VERSION) - current Ansel version") },
          { NULL, NULL } };
