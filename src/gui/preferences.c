/*
    ...
    Copyright (C) 2011-2018, 2020 Tobias Ellinghaus.
    Copyright (C) 2011 Ulrich Pegelow.
    Copyright (C) 2012-2013, 2016 Jérémy Rosen.
    Copyright (C) 2012, 2014, 2017-2018, 2020 parafin.
    Copyright (C) 2012 Richard Wonka.
    Copyright (C) 2013 Moritz Lipp.
    Copyright (C) 2013, 2019-2022 Pascal Obry.
    Copyright (C) 2013-2017, 2020 Roman Lebedev.
    Copyright (C) 2013-2014 Ronny Kahl.
    Copyright (C) 2013 Simon Spannagel.
    Copyright (C) 2013 Thomas Pryds.
    Copyright (C) 2017 Rikard Öxler.
    ...
    Copyright (C) 2019 maruncz.
    Copyright (C) 2019 PaoloAst.
  ...
  while(sqlite3_step(stmt) == SQLITE_ROW)
  {
    ...
    else
    {
      ...
      if(iso_min == 0.0 && iso_max == FLT_MAX)
        ...
        iso = g_strdup_printf("%" PRIu64 " - %" PRIu64 "", (size_t)iso_min, (size_t)iso_max);
