                                               ...
                                               float *x, float *y)
{
  ...
  {
#ifdef _OPENMP
#pragma omp parallel for SIMD() dt_omp_default() firstprivate(res, x) schedule(static)
#endif
  ...
  {
#ifdef _OPENMP
#pragma omp parallel for SIMD() dt_omp_default() firstprivate(min, max, res, y, c) schedule(static)
#endif
