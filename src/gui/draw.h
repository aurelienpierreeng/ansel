                                               ...
                                               float *x, float *y)
{
  ...
  {
#ifdef _OPENMP
#pragma omp parallel for simd default(firstprivate) firstprivate(res, x) schedule(static)
#endif
  ...
  {
#ifdef _OPENMP
#pragma omp parallel for simd default(firstprivate) firstprivate(min, max, res, y, c) schedule(static)
#endif
