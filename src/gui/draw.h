                                               ...
                                               float *x, float *y)
{
  ...
  {
#ifdef _OPENMP
#pragma omp parallel for SIMD() default(none) dt_omp_firstprivate(res) dt_omp_firstprivate(x) schedule(static)
#endif
  ...
  {
#ifdef _OPENMP
#pragma omp parallel for SIMD() default(none) dt_omp_firstprivate(min, max, res) dt_omp_firstprivate(y, c) schedule(static)
#endif
