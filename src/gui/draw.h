                                               ...
                                               float *x, float *y)
{
  ...
  {
#ifdef _OPENMP
#pragma omp parallel for SIMD() dt_omp_default() dt_omp_firstprivate(res, x) schedule(static)
#endif
  ...
  {
#ifdef _OPENMP
#pragma omp parallel for SIMD() dt_omp_default() dt_omp_firstprivate(min, max, res, y, c) schedule(static)
#endif
