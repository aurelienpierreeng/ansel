/*
    ...
    Copyright (C) 2013 Dimitrios Psychogios.
    Copyright (C) 2013-2014 Jérémy Rosen.
    Copyright (C) 2013 Pascal de Bruijn.
    Copyright (C) 2013-2017, 2019-2020 Tobias Ellinghaus.
    Copyright (C) 2014, 2018, 2020-2021 Pascal Obry.
                ...
                const gboolean export_masks)
{
  ...
  {
    fprintf(stderr, "[webp export] error writing %" PRIu64 " bytes to file %s\n", assembled_data.size, filename);
    goto out;
  }
...
void gui_init(dt_imageio_module_format_t *self)
{
  ...
  gui->hint = dt_bauhaus_combobox_new(darktable.bauhaus, DT_GUI_MODULE(NULL));
  dt_bauhaus_widget_set_label(gui->hint, N_("image hint"));
