...
{
  dt_imageio_jxl_gui_data_t *gui = (dt_imageio_jxl_gui_data_t *)malloc(sizeof(dt_imageio_jxl_gui_data_t));
  if(!gui) return;
  self->gui_data = gui;
  ...
  DT_BAUHAUS_COMBOBOX_NEW_FULL(darktable.bauhaus, gui->bpp, NULL, N_("bit depth"),
                               NULL, bpp_enum, (GtkCallback) bpp_changed,
  ...
  DT_BAUHAUS_COMBOBOX_NEW_FULL(darktable.bauhaus, gui->pixel_type, NULL, N_("pixel type"),
                               NULL, pixel_type, (GtkCallback) pixel_type_changed,
  ...
  gui->quality = dt_bauhaus_slider_new_with_range(darktable.bauhaus, DT_GUI_MODULE(NULL), 
      dt_confgen_get_int("plugins/imageio/format/jxl/quality", DT_MIN),
  ...
  DT_BAUHAUS_COMBOBOX_NEW_FULL(darktable.bauhaus, gui->original, NULL, N_("encoding color profile"),
      ...
      original, (GtkCallback) original_changed, N_("internal"), N_("original"));
  ...
  gui->effort = dt_bauhaus_slider_new_with_range(darktable.bauhaus, DT_GUI_MODULE(NULL), 
      dt_confgen_get_int("plugins/imageio/format/jxl/effort", DT_MIN),
  ...
  dt_bauhaus_widget_set_label(gui->effort, N_("encoding effort"));
  ...
  gui->tier = dt_bauhaus_slider_new_with_range(darktable.bauhaus, DT_GUI_MODULE(NULL), 
      dt_confgen_get_int("plugins/imageio/format/jxl/tier", DT_MIN),
  ...
  dt_bauhaus_widget_set_label(gui->tier, N_("decoding speed"));
