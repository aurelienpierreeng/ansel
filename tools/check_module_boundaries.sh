...
# 73 -> 67 when the pipe's snapshot lifecycle went through dt_masks_forms_snapshot_ensure() /
# _release() and retouch resolved every pipeline-side shape through one rt_pipe_get_form().
